...
def ai_score_founder(row):
    prompt = (
        ...
        "- Are focused purely on services businesses, agencies, consultancies, or venture studios. "
        ""
...
def past_success_indication_score(row, json=False):
    prompt = (
        ...
        "9-10: Exceptional indicators of success (e.g., elite university, significant achievements, highly successful company) "
        ""
        "Consider factors such as: "
        "- Educational background (quality of institutions, degrees obtained) "
        "- Career progression and growth "
        "- Leadership positions held "
        "- How big and prestigious, successful the companies they worked at are "
        ""
        "Please provide a score (0-10), a confidence level (1-10), and a brief reasoning. "
        "Structure your response exactly as: "
        ""
